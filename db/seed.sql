...
INSERT INTO commissions (title, description, tags, author_token, created_at) VALUES
  ...
  ('招 C# 开发者合作开发派系扩展模组', '已有完整设计文档，需要一个熟悉 Harmony 的开发者协助实现 AI 行为扩展。', 'framework,weapon', '7f9c0a1b-2d3e-4f5a-6b7c-8d9e0f1a2b3c', datetime('now', '-1 day')),
  ('整合包汉化委托招文案与翻译', '包含多个模组的整合包，需要文案润色与文本翻译协作完成汉化。', 'race', 'f4e3d2c1-b0a9-8f7e-6d5c-4b3a2f1e0d9c', datetime('now'));
