...
INSERT INTO commissions (title, description, tags, author_name, author_token, author_id, created_at) VALUES
  ...
  ('整合包汉化委托招文案与翻译', '包含多个模组的整合包，需要文案润色与文本翻译协作完成汉化。', 'race', '边缘行者', 'f4e3d2c1-b0a9-8f7e-6d5c-4b3a2f1e0d9c', 'f6e5d4c3b2a1', datetime('now'));
